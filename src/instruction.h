...
struct Instruction
{
    ...
    static constexpr EnumArray<Type, const char*> TypeStr = {
    ...
    static constexpr EnumArray<Addressing, const char*> AddressingStr = {
        "NONE", "R",    "R_R",   "MR_R", "HLI_R", "HLD_R", "A8_R",  "A16_R", "MR",    "R_MR",
    ...
    static constexpr EnumArray<Register, const char*> RegisterStr = {"NONE", "A",  "F",  "B",  "C",  "D",  "E", "H",
                                                                     "L",    "AF", "BC", "DE", "HL", "SP", "PC"};
    ...
    static constexpr EnumArray<Register, const char*> ConditionStr = {"NONE", "NZ", "Z", "NC", "C"};

    static Instruction instructions[0x100];

    using Function = void (*)(Gameboy& gb);
